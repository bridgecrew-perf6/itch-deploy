...
export default class Proyecto extends Component{
    ...
    showEvaluacionAsesorExterno = () => {
        axios.get('/api/proyecto/evaluacion/criterios/asesor_externo')
            .then(res => {
                if(res.status === 200){
                    ...
                    <Col xs={24} lg={24}>
                        {
                            ...
                            ?
                                <div>
                                    <Button style={{marginBottom: 30}} onClick={() => this.showEvaluacionAsesorExterno()} icon="bars" type="primary">Realizar evaluación</Button>
